...
Each component of the Nexus zkVM has been carefully designed or selected and then implemented by the [Nexus team](https://nexus.xyz) to maximize security, performance, modularity, and extensibility. As a consequence of that design, the Nexus zkVM is architected to be extensible in response to new theoretical developments, as well as to support comprehensive tooling for a variety of use cases and applications domains:
