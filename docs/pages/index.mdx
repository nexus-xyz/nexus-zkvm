...
As a consequence of that design, the Nexus zkVM is architected to support new theoretical developments led by our science team, as well as tooling to accelerate deploying the zkVM for a variety of use cases:

- **Proving Schemes**: In addition to the Nova familiy of folding schemes, the Nexus Prover can be extended with new proving scheme constructions as the theoretical and practical state-of-the-art continue to advance.
