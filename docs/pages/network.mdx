...
The global Nexus Network is designed to run at a over a trillion CPU cycles per second given enough computing power connected to it, creating a world-scale supercomputer with the capacity to prove many of the world's most important computations quickly and correctly.
