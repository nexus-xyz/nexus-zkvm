...
#[cfg(feature = "legacy-hypernova")]
fn main() {
    legacy_hypernova::run();
}

#[cfg(not(feature = "legacy-hypernova"))]
fn main() {
    println!("This example requires the 'legacy-hypernova' feature to be enabled.");
    println!("Please rebuild with '--features legacy-hypernova'");
}
