...
mod tests {
    ...
    fn test_mulh_positive_numbers() {
        ...
        let bare_instruction = Instruction::new(Opcode::MULH, 3, 1, 2, InstructionType::RType);
    ...
    fn test_mulhu_large_unsigned() {
        ...
        let bare_instruction = Instruction::new(Opcode::MULHU, 3, 1, 2, InstructionType::RType);
    ...
    fn test_mulhsu_positive_signed_large_unsigned() {
        ...
        let bare_instruction = Instruction::new(Opcode::MULHSU, 3, 1, 2, InstructionType::RType);
