...
mod tests {
    ...
    fn test_sh_positive_value() {
        ...
        let bare_instruction = Instruction::new(Opcode::SH, 2, 1, 0, InstructionType::SType);
    ...
    fn test_sh_negative_value() {
        ...
        let bare_instruction = Instruction::new(Opcode::SH, 2, 1, 2, InstructionType::SType);
        let instruction = ShInstruction::decode(&bare_instruction, &cpu.registers);
    ...
    fn test_sh_max_value() {
        ...
        let bare_instruction = Instruction::new(Opcode::SH, 2, 1, 4, InstructionType::SType);
        let instruction = ShInstruction::decode(&bare_instruction, &cpu.registers);
    ...
    fn test_sh_overflow() {
        ...
        let bare_instruction = Instruction::new(Opcode::SH, 2, 1, 1, InstructionType::SType);
        let instruction = ShInstruction::decode(&bare_instruction, &cpu.registers);
