...
mod tests {
    ...
    fn test_beq_branch_taken() {
        ...
        let bare_instruction = Instruction::new(Opcode::BEQ, 1, 2, 0x100, InstructionType::BType);
    ...
    fn test_beq_zero_offset() {
        ...
        let bare_instruction = Instruction::new(Opcode::BEQ, 1, 2, 0, InstructionType::BType);
    ...
    fn test_beq_negative_offset() {
        ...
        let bare_instruction = Instruction::new(Opcode::BEQ, 1, 2, offset, InstructionType::BType);
    ...
    fn test_beq_same_register() {
        ...
        let bare_instruction = Instruction::new(Opcode::BEQ, 1, 1, 0x100, InstructionType::BType);
