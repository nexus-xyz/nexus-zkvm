...
mod tests {
    ...
    fn test_blt_branch_taken() {
        ...
        let bare_instruction = Instruction::new(Opcode::BLT, 1, 2, 0x100, InstructionType::BType);
    ...
    fn test_blt_negative_offset() {
        ...
        let bare_instruction = Instruction::new(Opcode::BLT, 1, 2, offset, InstructionType::BType);
    ...
    fn test_bltu_branch_taken() {
        ...
        let bare_instruction = Instruction::new(Opcode::BLTU, 1, 2, 0x100, InstructionType::BType);
    ...
    fn test_bltu_negative_offset() {
        ...
        // Use a negative offset (-0x100)
        let offset = (!256u32).wrapping_add(1);
        let bare_instruction = Instruction::new(Opcode::BLTU, 1, 2, offset, InstructionType::BType);
