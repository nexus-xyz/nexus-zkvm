...
use crate::{
    column::Column::{
        ...
        IsLh, IsLhu, IsLui, IsLw, IsMul, IsMulhu, IsOr, IsPadding, IsSb, IsSh, IsSll, IsSlt,
        ...
        OpC0, OpC11, OpC12, OpC20, OpC4, PcCarry, ProgCtrCarry, RemAux, SgnA, SgnB, SgnC,
...
const CHECKED_SINGLE: [Column; 51] = [
    ValueAEffectiveFlag,
    ImmC,
    IsAdd,
    IsOr,
...
const TYPE_R_CHECKED_SINGLE: [Column; 13] = [
    OpC4,
    OpA0,
    OpB0,
    MulCarry0,
