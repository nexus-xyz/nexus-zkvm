...
pub trait SltuOp {
    ...
    ///
    /// op-c is an immediate in case of SLTIU
...
impl<S: SltuOp> BuiltInComponent for Sltu<S> {
    ...
    fn generate_interaction_trace(
        ...
        assert_eq!(
            ...
            Column::COLUMNS_NUM + S::LocalColumn::COLUMNS_NUM
        );
        ...
        let [_h_borrow_1, h_borrow_2] = original_base_column!(component_trace, Column::HBorrow);
        ...
        let mut a_val = vec![BaseField::zero().into(); WORD_SIZE];
        a_val[0] = h_borrow_2;
        // provide(
    ...
    fn add_constraints<E: EvalAtRow>(
        ...
        let mut a_val = vec![E::F::zero(); WORD_SIZE];
        a_val[0] = h_borrow_2;
        // provide(
        //     rel-inst-to-reg-memory,
        //     1 − is-local-pad,
