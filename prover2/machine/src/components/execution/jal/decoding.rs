...
use super::{Column, PreprocessedColumn};
use crate::{
...
impl Decoding {
    pub(super) fn generate_decoding_trace_row(
        ...
        range_check_accum
            .range8
            .add_values_from_slice(&[op_c1_3, op_c8_10]);
        range_check_accum
            .range16
            .add_values_from_slice(&[op_a1_4, op_c4_7, op_c12_15, op_c16_19]);
    }
    ...
    pub(super) fn constrain_decoding<E: EvalAtRow>(
        ...
        for col in [op_c1_3, op_c8_10] {
            range_check
                .range8
                .constrain(eval, is_local_pad.clone(), col);
        }
        for col in [op_a1_4, op_c4_7, op_c12_15, op_c16_19] {
            range_check
                .range16
                .constrain(eval, is_local_pad.clone(), col);
        }
    ...
    pub(super) fn generate_interaction_trace(
        ...
        let [op_c1_3] = original_base_column!(component_trace, Column::OpC1_3);
        ...
        let [op_c12_15] = original_base_column!(component_trace, Column::OpC12_15);
        let [op_c16_19] = original_base_column!(component_trace, Column::OpC16_19);
